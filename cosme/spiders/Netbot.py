...
class Cosme(CrawlSpider):
    ...
    start_urls = ["http://www.netfarma.com.br/categoria.asp?idcategoria=1629&nivel=02&categoria=Maquiagem&topo=s", "http://www.netfarma.com.br/categoria.asp?idcategoria=2713&nivel=11&categoria=Perfumes&topo=s"]
