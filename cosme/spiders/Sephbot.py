...
class Cosme(CrawlSpider):
    ...
    deny_exts = (r'newsletter',r'\.php',r'busca', r'mac', r'include', r'ajax', r'basket', r'cesta\.asp',r'comprar\.asp', r'view=all', r'compartilhe\.asp', r'produto\.asp\?id=\d+', r'marca\.asp\?[\w&=]+', r'avise-me\.asp\?id=\d+', r'produtoDetalhe\.asp')
   # allow_exts = (r'produto.asp\?idproduto=\d+')
